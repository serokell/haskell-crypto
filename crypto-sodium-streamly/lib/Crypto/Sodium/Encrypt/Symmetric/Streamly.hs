...
--
-- @
-- import qualified Crypto.Sodium.Encrypt.Symmetric.Streamly as Symmetric
--
...
module Crypto.Sodium.Encrypt.Symmetric.Streamly
  (
  -- * Keys
    Key
  , toKey
...
import Crypto.Sodium.Encrypt.Symmetric.Stream (toKey, Key)
...
import Crypto.Sodium.Streamly.Util (mapLastSpecialM)
...
--     See "Crypto.Sodium.Key" in @crypto-sodium@ for how to get one.
--
...
-- See "Crypto.Sodium.Init" in @crypto-sodium@ for details.
encrypt
